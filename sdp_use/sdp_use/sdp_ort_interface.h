...
namespace sdp {
	...
	public:
        ...
        // 移动构造和赋值
        sdp_ort_interface(sdp_ort_interface&& other) noexcept;
        sdp_ort_interface& operator=(sdp_ort_interface&& other) noexcept;

        // 禁止拷贝
        sdp_ort_interface(const sdp_ort_interface&) = delete;
        sdp_ort_interface& operator=(const sdp_ort_interface&) = delete;
